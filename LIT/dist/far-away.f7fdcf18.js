...
})({"1C744":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "e9c315adf7fdcf18";
"use strict";
...
},{}],"lAuVg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "tipStore", ()=>(0, _tipStore.tipStore)) // export * from "./store/TodoStore"
 // export * from "./store/PersonStore";
 // export * from "./store/PersonStoreConv"
;
var _tipCalculator = require("./registry/tip-calculator");
parcelHelpers.exportAll(_tipCalculator, exports);
var _billAmount = require("./registry/bill-amount");
parcelHelpers.exportAll(_billAmount, exports);
var _finalAmount = require("./registry/final-amount");
parcelHelpers.exportAll(_finalAmount, exports);
var _selectRating = require("./registry/select-rating");
parcelHelpers.exportAll(_selectRating, exports);
var _tipStore = require("./store/TipStore");

},{"./registry/tip-calculator":"3Ys2G","./registry/bill-amount":"49rHV","./registry/final-amount":"a8WlU","./registry/select-rating":"9xXqa","./store/TipStore":"1mHgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3Ys2G":[function(require,module,exports) {
var _tipCalculator = require("../TipCalculator");
const TAG_NAME = "tip-calculator";
if (!customElements.get(TAG_NAME)) customElements.define(TAG_NAME, (0, _tipCalculator.TipCalculator));

},{"../TipCalculator":"jE4Vw"}],"jE4Vw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TipCalculator", ()=>TipCalculator);
...
class TipCalculator extends (0, _litMobx.MobxLitElement) {
    constructor(){
        super(...arguments);
        // @state()
    ...
    render() {
        const initialBillAmount = (0, _tipStore.tipStore).actualBillAmount;
        this.percentage1 = (0, _tipStore.tipStore).currentFirstRating;
        this.percentage2 = (0, _tipStore.tipStore).currentSecondRating;
        return (0, _lit.html)`
            <div
            ...
            >
               ...
               <div slot="question">
                ...
                <div slot="question">
                 ...
                 ${(0, _when.when)(initialBillAmount > 0, ()=>(0, _lit.html)` <final-amount>
                        <div slot="final">
                            <h3>Final bill amount:</h3>
                            <p>Actual bill: ${initialBillAmount} </p>
                            <p>Your rating:${(0, _tipStore.tipStore).currentFirstRating} </p>
                            <p>Your friend rating: ${(0, _tipStore.tipStore).currentSecondRating}</p>
    ...
    renderCalculatedAmount() {
        ...
        return (0, _lit.html)`
                    <span>
                     ...
                     ${(0, _tipStore.tipStore).finalBillAmount}
                `;
    }
}
__decorate([
...
},{"@adobe/lit-mobx":"8SIpA","lit":"4antt","lit/decorators":"bCPKi","lit/directives/when":"5IbUr","./store/TipStore":"1mHgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8SIpA":[function(require,module,exports) {
/*
...
},{}],"coRKn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./base.js":"d0R9Y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5IbUr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "when", ()=>nn);
function nn(n, r, t) {
    return n ? r(n) : t?.(n);
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1mHgQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "tipStore", ()=>tipStore);
var _mobx = require("mobx");
var __decorate = undefined && undefined.__decorate || function(decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"mobx":"coRKn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49rHV":[function(require,module,exports) {
var _billAmountBox = require("../BillAmountBox");
const TAG_NAME = "bill-amount";
if (!customElements.get(TAG_NAME)) customElements.define(TAG_NAME, (0, _billAmountBox.BillAmountBox));

},{"../BillAmountBox":"dzw7y"}],"dzw7y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// import { action, makeObservable, observable } from "mobx";
parcelHelpers.export(exports, "BillAmountBox", ()=>BillAmountBox);
var _litMobx = require("@adobe/lit-mobx");
var _lit = require("lit");
var _decorators = require("lit/decorators");
...
class BillAmountBox extends (0, _litMobx.MobxLitElement) {
    constructor(){
        super();
        // @property({ type: Number})
        // @state()
        ...
        /**Using mobx */ Object.defineProperty(this, "onBillInitialAmountChange", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (e)=>{
                const amount = e.target;
                (0, _index.tipStore).setBillAmount(Number(amount.value));
                this.amountValue = (0, _index.tipStore).actualBillAmount;
            }
        });
        // @action
...
},{"@adobe/lit-mobx":"8SIpA","lit":"4antt","lit/decorators":"bCPKi","lit/directives/guard":"kI5BX","./index":"lAuVg","mobx":"coRKn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kI5BX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a8WlU":[function(require,module,exports) {
var _finalAmountDisplay = require("../FinalAmountDisplay");
const TAG_NAME = "final-amount";
if (!customElements.get(TAG_NAME)) customElements.define(TAG_NAME, (0, _finalAmountDisplay.FinalAmountDisplay));

},{"../FinalAmountDisplay":"8diG9"}],"8diG9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FinalAmountDisplay", ()=>FinalAmountDisplay);
var _lit = require("lit");
class FinalAmountDisplay extends (0, _lit.LitElement) {
    render() {
        return (0, _lit.html)`
            <div>
...
},{"lit":"4antt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9xXqa":[function(require,module,exports) {
var _selectOptionForRating = require("../SelectOptionForRating");
const TAG_NAME = "select-rating";
if (!customElements.get(TAG_NAME)) customElements.define(TAG_NAME, (0, _selectOptionForRating.SelectOptionForRating));

},{"../SelectOptionForRating":"kvPka"}],"kvPka":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SelectOptionForRating", ()=>SelectOptionForRating);
var _lit = require("lit");
var _decorators = require("lit/decorators");
var _tipStore = require("./store/TipStore");
var __decorate = undefined && undefined.__decorate || function(decorators, target, key, desc) {
...
class SelectOptionForRating extends (0, _lit.LitElement) {
    constructor(){
        super(...arguments);
    ...
    handleSelectOption(e) {
        ...
        if (optionValue.getAttribute("is-first") !== null) (0, _tipStore.tipStore).updateRatingByFirstPerson(Number(optionValue.value));
        else (0, _tipStore.tipStore).updateRatingBySecondPerson(Number(optionValue.value));
...
},{"lit":"4antt","lit/decorators":"bCPKi","./store/TipStore":"1mHgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1C744","lAuVg"], "lAuVg", "parcelRequire39d8")

//# sourceMappingURL=far-away.f7fdcf18.js.map
