...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"customElement-lifecycle/CountElemLifeCycle-v2.js":[function(require,module,exports) {
...
var CountElementLifecycleMethods = /*#__PURE__*/function (_HTMLElement) {
  function CountElementLifecycleMethods() {
    var _this;
    _classCallCheck(this, CountElementLifecycleMethods);
    _this = _callSuper(this, CountElementLifecycleMethods);
    // define attributes
    _defineProperty(_this, "countElement", void 0);
    _defineProperty(_this, "decrementMethod", void 0);
    _defineProperty(_this, "incrementMethod", void 0);
    console.log('constructor method');
    _this._shadowRoot = _this.attachShadow({
      mode: 'open'
    });
    _this._shadowRoot.innerHTML = "\n    <button id=\"decrement\">-</button>\n    <span id=\"count\">0</span>\n    <button id=\"increment\">+</button>\n    ";
    _this.countElement = _this._shadowRoot.querySelector('#count');
    _this.decrementMethod = _this._shadowRoot.querySelector('#decrement');
    _this.incrementMethod = _this._shadowRoot.querySelector('#increment');
    return _this;
  }
  _inherits(CountElementLifecycleMethods, _HTMLElement);
  return _createClass(CountElementLifecycleMethods, [{
    key: "initialvalue",
    get:
    ...
    value: function attributeChangedCallback(name, oldValue, newValue) {
      console.log("".concat(name, "'s changed from ").concat(oldValue, " to ").concat(newValue));
    }
  }, {
...
},{}]},{},["../../../../../.nvm/versions/node/v14.18.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","customElement-lifecycle/CountElemLifeCycle-v2.js"], null)
//# sourceMappingURL=/CountElemLifeCycle-v2.26dddc7e.js.map