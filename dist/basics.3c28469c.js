...
var request = fetch("https://restcountries.com/v3.1/name/".concat(countryName)).then(function (response) {
  return response.json();
}).then(function (countrydata) {
  var _countrydata = _slicedToArray(countrydata, 1),
    data = _countrydata[0];
  // console.log(data);
  return fetch("https://restcountries.com/v3.1/name/".concat(data.borders[0]));
}).then(function (response) {
  return response.json();
}).then(function (data2) {
  var _data = _slicedToArray(data2, 1),
    data = _data[0];
  // console.log(data);
});
